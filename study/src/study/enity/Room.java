...
public class Room extends Facility {
    ...
    public Room(boolean status,String facilityCode, String facilityName, double usableArea, int rentalCost, int maxOfPeople, RentalType rentalType, String freeService) {
